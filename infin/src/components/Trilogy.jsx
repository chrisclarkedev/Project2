    ...
    <section id="trilogy">
      ...
      <div id="trilogy-info">
        ...
        <p>All of Marvel's top heroes star in this cosmic epic, where they must stop the Infinity-fueled "Mad Titan"
          Thanos, Magus (Adam Warlock's evil counterpart), and the Goddess (Adam Warlock's 'benevolent' counterpart)
          - all of whom have been infused with near-omnipotent power of the Infinity Gems!</p>
